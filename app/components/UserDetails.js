...
function UserDetails (user) {
  return (
    <div>
      ...
      <li className='list-group-item'><img src={user.info.avatar_url} alt='Avatar' className='img-rounded img-responsive' /></li>
      ...
      {user.info.blog && <li className='list-group-item'><a href={user.info.blog}>{user.info.blog}</a></li>}
    </div>
  )
}
